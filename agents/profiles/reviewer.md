...
- **sonnet combined review widened to small behavioral patches with latitude** — n=2 clean (w3 A12 lib patch, A13 multi-part app consume; both zero-finding, mechanism-level adjudications incl. upholding a scope deviation against main's blob). (2026-07-20/21)
